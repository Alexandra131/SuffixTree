...
(define-syntax-rule (collection-empty? L) (stream-empty? L))
(define empty-collection empty-stream)
(define-syntax-rule (collection-firs L) (stream-first L))
(define-syntax-rule (collection-rest L) (stream-rest L))
(define-syntax-rule (collection-map f L) (stream-map f L))
(define-syntax-rule (collection-filter f L) (stream-filter f L))
